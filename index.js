...
var firebaseConfig = {
  apiKey: "AIzaSyCMPP1Qv-btwuzk-Exc_NTv_qNviSIonXY",
  authDomain: "swarksha.firebaseapp.com",
  databaseURL: "https://swarksha.firebaseio.com",
  projectId: "swarksha",
  storageBucket: "swarksha.appspot.com",
  messagingSenderId: "340364969638",
  appId: "1:340364969638:web:00f237a61e35d289601667"
};
    ...
    if (data.val()) {
      ...
      teachers.forEach((teacher) => {
        if (
          ...
          var total = firebase.database().ref('User');
          var second = firebase.database().ref('Locations/users');
